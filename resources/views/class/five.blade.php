...
<?php 
  $total_class_in_class =  DB::table('allvideos')->where('class_id','15')->count();
  $word_converter = new BanglaNumberToWord();
$last_update_time =  DB::table('allvideos')->where('class_id','15')->orderBy('created_at', 'desc')->first();
  $last_update= date("j-F-Y h:i A",strtotime($last_update_time->created_at));

?>
  <marquee style="color:red;font-weight:bold;font-size:20px;"><span style="color:green">Last Update: {{$last_update}} |</span> লেসন প্ল্যান অনুযায়ী পঞ্চম শ্রেণির মোট {{BanglaConverter::en2bn($total_class_in_class) }} ( {{$word_converter->numToWord($total_class_in_class)}} )  টি ক্লাস আপলোড করা হয়েছে। </marquee>
  ...
  <div class="panel panel-primary">
    ...
    <div id="lession1" class="panel-collapse collapse">
      <ul class="list-group">
        ...
        <li class="list-group-item"><a href="http://sscraj.com/wp-content/uploads/2020/05/Five.pdf"><b>Section:</b> Red</a> <a href="http://sscraj.com/wp-content/uploads/2020/05/Five.pdf" style="Background-color:green;color:#fff;padding: 5px;border-radius: 2px;font-weight: bold;position: absolute;right: 10px;top: 5px;" >Download Now</a></li>
        
        <li class="list-group-item"><a href="http://sscraj.com/wp-content/uploads/2020/05/Five-1.pdf"><b>Date:</b> 31 May 2020</a><img src="https://traveltech.co.in/images/blink.gif" style="height: 20px;" alt="new class"> <a href="http://sscraj.com/wp-content/uploads/2020/05/Five-1.pdf" style="Background-color:green;color:#fff;padding: 5px;border-radius: 2px;font-weight: bold;position: absolute;right: 10px;top: 5px;" >Download Now</a></li>
      </ul>
    </div>
  </div>
...
$subjects = DB::table('allvideos')->where(array('class_id'=>'15','subject_id'=> $subject_id))->get();

$total_class=  DB::table('allvideos')->where(array('class_id'=>'15','subject_id'=> $subject_id))->count();
// print_r($total_class);
